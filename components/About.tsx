...
export default function About() {
    ...
    const aboutCopy = [
        "Product Associate with strong technical execution across product development, QA (manual + automation), UI/UX design, and engineering collaboration. Computer Science graduate (2023, **GPA 3.91/4.00**).",
        "Led **6–10 engineers** during a full-platform revamp at Kick Avenue, delivering **15+ PRDs**, scalable flows, and **100+ Playwright** automated test cases.",
